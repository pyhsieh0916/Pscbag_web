    ...
    var loadMyCartEvent = function (targetSelector) {
        ...
        if (!$("#" + idCartModal).length) {
            $('body').append(
                ...
                '<h4 class="modal-title" id="myModalLabel">PscBag 購物車</h4>' +
                ...
                '<button type="button" class="btn btn-primary ' + classCheckoutCart + '">下單</button>' +
                '</div>' +
                '</div>' +
                '</div>' +
                '</div>'
        ...
        var drawTable = function () {
            ...
            $cartTable.append(products.length ?
                ...
                '<tr>' +
                '<td style="width:20%;height:20px;">攤位名：</td>' +
                '<td> <input style="width:50%;height:20px; name=booth_name" /></td>' +
                '<td></td>' +
                '<td style="width:20%;height:20px;">攤號：</td>' +
                '<td> <input style="width:50%;height:20px; name=booth_num" /></td>' +
                '<td class="text-right"><strong id="' + idGrandTotal + '"></strong></td>' +
                '<td></td>' +
                '</tr>' +
                '<tr><td style="width:20%;height:20px;">電話：</td>' +
                '<td colspan="3"> <input style="width:90%;height:10%; name=phone" /></td></tr>' +
                '<tr><td style="width:20%;height:30%;">備註：</td>' +
                '<td colspan="3"> <input style="width:90%;height:30%; name=demo" /></td></tr>' 
 

                :
                '<div class="alert alert-danger" align=center role="alert" id="' + idEmptyCartMessage + '">購物車是空的</div>'
            );
